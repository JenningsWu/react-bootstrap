  ...
  render() {
    ...
    return this[renderMethod]([
      <Button
        ...
        onMouseEnter={createChainedFunction(this.props.onClick, this.handleDropdownClick)}
        onMouseLeave={createChainedFunction(this.props.onClick, this.handleDropdownClick)}
        key={0}
