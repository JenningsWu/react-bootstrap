  ...
  render: function render() {
    ...
    return this[renderMethod]([_react2['default'].createElement(
      ...
      _extends({}, this.props, {
        ...
        onMouseEnter: (0, _utilsCreateChainedFunction2['default'])(this.props.onClick, this.handleDropdownClick),
        onMouseLeave: (0, _utilsCreateChainedFunction2['default'])(this.props.onClick, this.handleDropdownClick),
        key: 0,
