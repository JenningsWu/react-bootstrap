...
var TabbedArea = _react2['default'].createClass({
  ...
  renderPane: function renderPane(child, index) {
    ...
    if (child.props.onClick) return;
    if (child.props.navItem) return _utilsValidComponentChildren2['default'].map(child.props.children, this.renderPane);
  ...
  renderMenu: function renderMenu(child) {
  ...
  renderTab: function renderTab(child) {
    ...
    var tab = _child$props2.tab;
    var disabled = _child$props2.disabled;
    var navItem = _child$props2.navItem;

    if (navItem) return _react2['default'].createElement(
      _DropdownButton2['default'],
      {
        ...
        title: tab,
        navItem: navItem },
      _utilsValidComponentChildren2['default'].map(child.props.children, this.renderMenu)
    );
    return _react2['default'].createElement(
      _NavItem2['default'],
      {
